#/bin/bash
# $Id: prepsystemvm.sh 9652 2010-06-16 00:40:45Z anthony $ $HeadURL: svn://svn.lab.vmops.com/repos/branches/2.0.0/java/scripts/vm/hypervisor/xenserver/patch/prepsystemvm.sh $
