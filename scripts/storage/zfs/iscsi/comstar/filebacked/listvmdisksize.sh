#!/usr/bin/env bash
# $Id: listvmdisksize.sh 9132 2010-06-04 20:17:43Z manuel $ $HeadURL: svn://svn.lab.vmops.com/repos/branches/2.1.x/java/scripts/storage/zfs/iscsi/comstar/filebacked/listvmdisksize.sh $
