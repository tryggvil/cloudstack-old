...
public class ListLoadBalancersCmd extends BaseCmd {
    public static final Logger s_logger = Logger.getLogger (ListLoadBalancersCmd.class.getName());
    ...
    public List<Pair<String, Object>> execute(Map<String, Object> params) {
        ...
        if ((account == null) || isAdmin(account.getType())) {
            ...
            if (domainId != null) {
                if ((account != null) && !getManagementServer().isChildDomain(account.getDomainId(), domainId)) {
                    throw new ServerApiException(BaseCmd.PARAM_ERROR, "Invalid domain id (" + domainId + ") given, unable to list load balancers.");
                }
                if (accountName != null) {
        ...
        Pair<String, Object> ruleTag = new Pair<String, Object>("loadbalancer", lbTag);
        lbTags.add(ruleTag);
        return lbTags;
    }
}
