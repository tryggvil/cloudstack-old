...
public class CreateUserCmd extends BaseCmd {
    ...
    public List<Pair<String, Object>> execute(Map<String, Object> params) {
        ...
        //Check the domainId
        if (domainId != null) {
        	domainId = (Long)params.get(BaseCmd.Properties.DOMAIN_ID.getName());
        }
        else {
        ...
        try {
            createdUser = getManagementServer().createUserAPI(username, password, firstname, lastname, domainId, accountName, accountType.shortValue(), email);
