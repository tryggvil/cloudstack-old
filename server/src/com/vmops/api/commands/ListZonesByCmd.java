    ...
    public List<Pair<String, Object>> execute(Map<String, Object> params) {
        ...
        for (DataCenterVO dataCenter : dataCenters) {
            ...
            if ((account == null) || isAdmin(account.getType())) {
                ...
                if (dataCenter.getDns3() != null) {
                    dcData.add(new Pair<String, Object>("dns3", dataCenter.getDns3()));
                }
                if (dataCenter.getDns4() != null) {
                    dcData.add(new Pair<String, Object>("dns4", dataCenter.getDns4()));
                }
