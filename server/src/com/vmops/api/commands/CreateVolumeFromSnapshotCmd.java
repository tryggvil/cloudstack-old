...
public class CreateVolumeFromSnapshotCmd extends BaseCmd {
	public static final Logger s_logger = Logger.getLogger(CreateVolumeFromSnapshotCmd.class.getName());
	   private static final String s_name = "createvolumefromsnapshotresponse";
