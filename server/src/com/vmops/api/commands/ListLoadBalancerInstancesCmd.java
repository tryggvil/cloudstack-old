...
public class ListLoadBalancerInstancesCmd extends BaseCmd {
    public static final Logger s_logger = Logger.getLogger (ListLoadBalancerInstancesCmd.class.getName());

    private static final String s_name = "listloadbalancerinstancesresponse";
    ...
    public List<Pair<String, Object>> execute(Map<String, Object> params) {
        ...
        if (loadBalancer == null) {
            throw new ServerApiException(BaseCmd.PARAM_ERROR, "no load balancer with id " + loadBalancerId + " exists.");
        }
        ...
        if (account != null) {
            ...
            if (isAdmin(account.getType())) {
                ...
                if (!getManagementServer().isChildDomain(account.getDomainId(), userAccount.getDomainId())) {
                    throw new ServerApiException(BaseCmd.PARAM_ERROR, "Invalid load balancer id (" + loadBalancerId + ") given, unable to list instances.");
                }
        ...
        if (instances == null) {
            throw new ServerApiException(BaseCmd.NET_LIST_ERROR, "unable to find instances for load balancing rule " + loadBalancerId);
        }
        ...
        Pair<String, Object> ruleTag = new Pair<String, Object>("loadbalancerinstance", instanceTag);
