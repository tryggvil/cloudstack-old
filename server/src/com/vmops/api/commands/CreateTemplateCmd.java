...
import com.vmops.async.executor.CreatePrivateTemplateResultObject;
    ...
    public List<Pair<String, Object>> execute(Map<String, Object> params) {
        ...
        if ((templates != null) && !templates.isEmpty()) {
            for (VMTemplateVO template : templates) {
                if (template.getName().equalsIgnoreCase(name) && !AsyncInstanceCreateStatus.Corrupted.equals(template.getCreateStatus())) {
