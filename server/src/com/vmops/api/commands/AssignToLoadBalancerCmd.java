...
public class AssignToLoadBalancerCmd extends BaseCmd {
    public static final Logger s_logger = Logger.getLogger(AssignToLoadBalancerCmd.class.getName());

    private static final String s_name = "assigntoloadbalancerresponse";
