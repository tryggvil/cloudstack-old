#!/bin/bash
# $Id: send_password_to_domu.sh 9804 2010-06-22 18:36:49Z alex $ $HeadURL: svn://svn.lab.vmops.com/repos/branches/2.1.x/java/patches/kvm/root/send_password_to_domu.sh $
# @VERSION@
