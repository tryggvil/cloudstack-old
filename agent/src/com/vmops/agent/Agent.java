...
import com.vmops.utils.nio.NioClient;
import com.vmops.utils.nio.NioConnection;
 ...
 *
 * @see {@link com.vmops.agent.resource.storage.ZfsIscsiStorageResource}
 * @see {@link com.vmops.agent.resource.computing.ComputingResource}
 * @see {@link com.vmops.agent.resource.routing.RoutingResource}
 **/
public class Agent implements HandlerFactory, IAgentControl {
    ...
    public void start() {
        if (!_resource.start()) {
            ...
            throw new VmopsRuntimeException("Unable to start the resource: " + _resource.getName());
        }
        _connection.start();
    }
