...
public class Connection {
    ...
    /**
     * Create a connection to a particular server using a given username and password. This object can then be passed in
     * to any other API calls.
     * 
     * To login to a miami box we call login_with_password(username, password, "1.2") on rio this call fails and we
     ...
     */
    public Connection(String client, String username, String password) throws java.net.MalformedURLException, org.apache.xmlrpc.XmlRpcException, Types.BadServerResponse, Types.SessionAuthenticationFailed {
    ...
    /*
     * Because the binding calls are constructing their own parameter lists, they need to be able to get to the session
     * reference directly. This is all rather ugly and needs redone
     */
