...
//    viewer.options.disableShareDesktop();
  ...
  public void writeKeyEvent(KeyEvent evt) throws IOException {
    ...
    if(s_logger.isDebugEnabled())
    	s_logger.debug("Write key event, key: " + key + ", down: " + down + ", modifiers: " + evt.getModifiers());
  ...
  public void writeKeyEvent(int keysym, boolean down) {
    ...
    if(s_logger.isDebugEnabled())
    	s_logger.debug("Send keyboard event on wire, keysym: 0x" + Integer.toHexString(keysym) + ", down: " + down);    
  }
