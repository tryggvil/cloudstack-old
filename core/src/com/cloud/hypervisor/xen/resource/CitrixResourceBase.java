...
public abstract class CitrixResourceBase implements StoragePoolResource, ServerResource {
    ...
    protected void createVIF(Connection conn, VM vm, String mac, String vlanTag, int rate, String devNum, boolean isPub) throws XenAPIException, XmlRpcException,
        ...
        String nwUuid = (isPub ? _host.publicNetwork : _host.privateNetwork);
        String pifUuid = (isPub ? _host.publicPif : _host.privatePif);
    ...
    protected StartRouterAnswer execute(StartRouterCommand cmd) {
        ...
        try {
            ...
            if ("untagged".equalsIgnoreCase(tag)) {
                ...
                network = enableVlanNetwork(Long.parseLong(tag), _host.privateNetwork, _host.privatePif);
            }
        ...
        try {
            ...
            try {
                ...
                for (Map.Entry<Object, Object> entry : props.entrySet()) {
                    ...
                    s_logger.info("Copying " + f + " to " + d + " on " + hr.address + " with permission " + p);
                    scp.put(f, d, p);
                    s_logger.info("Copied " + f + " to " + d + " on " + hr.address + " with permission " + p);
                }
            } catch (IOException e) {
