...
public interface HostDao extends GenericDao<HostVO, Long> {
    ...
    List<HostVO> findDirectAgentToLoad(Long msid, boolean msidInclusive, Long lastPingSecondsAfter, Long limit);
    ...
    List<String> getVlanIds(long hostId);
    
    void addVlan(long hostId, String vlanId);
    
    void removeVlan(long hostId, String vlanId);
