...
public class StartCommand extends AbstractStartCommand {
    ...
    public StartCommand(UserVm vm, String vmName, ServiceOffering offering, int networkRate, int multicastRate, DomainRouter router, String storageHost, String imagePath, String guestNetworkId, int utilization, int cpuWeight, List<VolumeVO> vols, Map<String, Integer> mappings, int bits, String isoPath, boolean bootFromISO, String guestOSDescription) {
...
//        networkRateMulticastMbps = offering.getMulticastRateMbps();
    ...
    public StartCommand(UserVmVO vm, String vmName, ServiceOffering offering, int networkRate, int multicastRate,
			...
			String guestNetworkId, int utilization, int cpuWeight, List<VolumeVO> vols, Map<String, Integer> mappings,
			boolean mirroredVols, int bits, String isoPath, boolean bootFromISO, String guestOSDescription) {
		super(vmName, storageIps, vols, mappings, mirroredVols);
        initialize(vm, offering, networkRate, multicastRate, router, imagePath, guestNetworkId, utilization, cpuWeight, bits, isoPath, bootFromISO, guestOSDescription);
