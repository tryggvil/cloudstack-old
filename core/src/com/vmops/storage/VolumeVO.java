...
public class VolumeVO implements Volume {
    ...
    public VolumeVO(Long id, String name, long hostId, long dcId, long podId, long accountId, long domainId, Long instanceId, String folder, String path, long size, Volume.VolumeType vType) {
        this.id = id;
        this.name = name;
        this.hostId = hostId;
