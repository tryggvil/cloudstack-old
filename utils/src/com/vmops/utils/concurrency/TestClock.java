 ...
 * 
 */
package com.vmops.utils.concurrency;
...
public class TestClock extends TimerTask {
    private static final Logger s_logger = Logger.getLogger(TestClock.class);
    ...
    public TestClock(Scheduler scheduler, int minutesPerHour, int hoursPerDay, int daysPerWeek, int daysPerMonth, int weeksPerMonth, int monthsPerYear) {
        ...
        s_logger.debug("Current timestamp is " + _year + " " + _month + " " + _day + " " + _week + " " + _hour +  " " + _minute);
    ...
    public void run() {
        synchronized(this) {
            ...
            // Currently the unused VolumeBackupListener also uses this TestClock
            // How it uses this is a mystery. Currently I have made it pass null in 
            // the scheduler argument to this clock. 
            if (_scheduler != null) {
